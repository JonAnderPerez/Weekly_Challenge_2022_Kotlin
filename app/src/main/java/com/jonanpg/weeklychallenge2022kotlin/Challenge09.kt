 ...
 */
fun main() {
    val naturalText = "Esto es un texto que se traducira a morse."
    val morseText = decode(naturalText)
    println(morseText)
    println(decode(morseText)) 
}

private fun decode(input: String): String {
    var decodedInput = ""
    val naturalDict = mapOf(
        "A" to ".—", 	"N" to "—.", 	"0" to "—————",
        "B" to "—...", 	"Ñ" to "——.——", "1" to ".————",
        "C" to "—.—.", 	"O" to "———", 	"2" to "..———",
        "CH" to "————", "P" to ".——.", 	"3" to "...——",
